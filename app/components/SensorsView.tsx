    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        <div className="bg-[#0f0f0f] border border-slate-800 rounded-2xl p-3.5 sm:p-5 shadow-sm">
          <div className="flex items-center justify-between text-slate-400 mb-2">
            <span className="text-[10px] sm:text-xs font-bold uppercase tracking-wider flex items-center gap-1">
              <Radio size={13} className="text-[#0ea5e9]" /> Stesen
            </span>
          ...
          <p className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight">4 / 4</p>
          <p className="text-[11px] text-slate-400 mt-1 truncate">16 sensor beroperasi</p>
        </div>

        <div className="bg-[#0f0f0f] border border-slate-800 rounded-2xl p-3.5 sm:p-5 shadow-sm">
          <div className="flex items-center justify-between text-slate-400 mb-2">
            <span className="text-[10px] sm:text-xs font-bold uppercase tracking-wider flex items-center gap-1">
              <Battery size={13} className="text-emerald-400" /> Bateri
            </span>
            <span className="text-[9px] sm:text-[10px] font-mono text-emerald-400 font-bold bg-emerald-950/60 px-1.5 py-0.5 rounded border border-emerald-900/50">
              Sihat
            </span>
          </div>
          <p className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight">86.5%</p>
          <p className="text-[11px] text-slate-400 mt-1 truncate">LiFePO4 simpanan 36j</p>
        </div>
        ...
        <div className="bg-[#0f0f0f] border border-slate-800 rounded-2xl p-3.5 sm:p-5 shadow-sm">
          ...
          <p className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight">17.8 V</p>
          <p className="text-[11px] text-slate-400 mt-1 truncate">Arus purata 1.78 A</p>
        </div>

        <div className="bg-[#0f0f0f] border border-slate-800 rounded-2xl p-3.5 sm:p-5 shadow-sm">
          <div className="flex items-center justify-between text-slate-400 mb-2">
            <span className="text-[10px] sm:text-xs font-bold uppercase tracking-wider flex items-center gap-1">
              <Wifi size={13} className="text-indigo-400" /> Rangkaian
            </span>
          ...
          <p className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight">-68 dBm</p>
          <p className="text-[11px] text-slate-400 mt-1 truncate">4G Cat-M1 + LoRa</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        {filteredSensors.map((node) => {
          ...
          return (
            <div
              key={node.id}
              className="bg-[#0f0f0f] rounded-2xl border border-slate-800 p-4 sm:p-6 shadow-md hover:border-slate-700 transition-all space-y-4 sm:space-y-5"
            >
              {/* Header Stesen */}
              <div className="flex justify-between items-start border-b border-slate-800/80 pb-3.5">
                ...
                <div className="text-right">
                  <span className="text-[10px] text-slate-500 block">Ping:</span>
                  <span className="text-[11px] sm:text-xs font-mono font-bold text-slate-300">{node.lastPing}</span>
                  <button
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                ...
                <div className="bg-[#141414] rounded-xl border border-slate-800/80 p-3 sm:p-3.5 space-y-1.5">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-slate-300 flex items-center gap-1.5">
                      <Droplets size={13} className="text-[#0ea5e9]" /> Paras Air
                    </span>
                  ...
                  <div className="flex items-baseline justify-between pt-1">
                    <span className="text-xl sm:text-2xl font-black text-white">{node.waterLevelSensor.reading.toFixed(2)}m</span>
                    <span className="text-[10px] sm:text-[11px] font-mono text-slate-400">{node.waterLevelSensor.accuracy}</span>
                  </div>
                  <p className="text-[10px] text-slate-500 font-mono truncate">
                    {node.waterLevelSensor.model} | {node.waterLevelSensor.temperature}°C
                  </p>
                </div>
                ...
                <div className="bg-[#141414] rounded-xl border border-slate-800/80 p-3 sm:p-3.5 space-y-1.5">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-slate-300 flex items-center gap-1.5">
                      <Activity size={13} className="text-indigo-400" /> Tolok Hujan
                    </span>
                  ...
                  <div className="flex items-baseline justify-between pt-1">
                    <span className="text-xl sm:text-2xl font-black text-white">{node.rainGauge.intensity.toFixed(1)} <span className="text-xs font-normal text-slate-400">mm/j</span></span>
                ...
                <div className="bg-[#141414] rounded-xl border border-slate-800/80 p-3 sm:p-3.5 space-y-1.5">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-slate-300 flex items-center gap-1.5">
                      <Zap size={13} className="text-amber-400" /> Kuasa Solar
                    </span>
                  ...
                  <div className="flex items-baseline justify-between pt-1">
                    ...
                    <span className="text-xs font-mono font-bold text-emerald-400">
                      {node.powerSystem.batteryPercent}%
                    </span>
                  </div>
                ...
                <div className="bg-[#141414] rounded-xl border border-slate-800/80 p-3 sm:p-3.5 space-y-1.5">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-slate-300 flex items-center gap-1.5">
                      <Wifi size={13} className="text-emerald-400" /> Modem & Kamera
                    </span>
